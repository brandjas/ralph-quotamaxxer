...
Wrapper flags (before --):
  ...
  --timeout <duration>     Max time to wait (e.g. 30m, 1h). 0 = forever (default)
  --source <src>           Data source: both (default), proxy, statusline
  --quiet                  Suppress waiting output
  --help                   Show this help

Guard flags:
  Same as wrapper flags. Exits 0 when clear, 1 on timeout.
...
Examples:
  ...
  quotamaxxer guard --threshold-5h 0.8 --timeout 30m  # standalone guard
